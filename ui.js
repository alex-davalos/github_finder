        ...
        output += `
          <div class="card card-body mb-2">
            <div class="row>
              ...
              <div class="col-md-6">
                <span class="btn btn-primary">Stars: ${repos.stargazers_count}</span>
                <span class="btn btn-secondary">Watchers: ${repos.watchers_count}</span>
                <span class="btn btn-success">Forks: ${repos.forks_count}</span>
              </div>
            </div>
          </div>
          `;     
